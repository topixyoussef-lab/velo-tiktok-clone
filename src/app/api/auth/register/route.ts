...
export async function POST(req: Request) {
  try {
    ...
    await db.execute({ sql: 'INSERT INTO users (id, username, display_name, password, country, age, gender) VALUES (?, ?, ?, ?, ?, ?, ?)', args: [id, username, display_name, hashedPassword, country || '', ageNum, gender || ''] });
